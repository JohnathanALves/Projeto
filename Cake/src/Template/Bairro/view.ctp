<div class="actions columns large-2 medium-3">
    <h3><?= __('Actions') ?></h3>
    <ul class="side-nav">
        <li><?= $this->Html->link(__('Edit Bairro'), ['action' => 'edit', $bairro->bairroid]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Bairro'), ['action' => 'delete', $bairro->bairroid], ['confirm' => __('Are you sure you want to delete # {0}?', $bairro->bairroid)]) ?> </li>
...
<div class="bairro view large-10 medium-9 columns">
    ...
    <div class="row">
        <div class="large-5 columns strings">
            <h6 class="subheader"><?= __('Bairroid') ?></h6>
        ...
        <div class="large-2 columns numbers end">
            ...
            <h6 class="subheader"><?= __('Liberacao Semana') ?></h6>
            <p><?= $this->Number->format($bairro->liberacao_semana) ?></p>
            <h6 class="subheader"><?= __('Populacao') ?></h6>
            <p><?= $this->Number->format($bairro->populacao) ?></p>
            <h6 class="subheader"><?= __('Alocacao') ?></h6>
